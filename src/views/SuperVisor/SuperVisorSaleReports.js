...
const SaleReports = () => {
  ...
  const fetchReports = async () => {
    try {
      ...
      //   return {
      //     ...sellerData,
      //     companyName: seller ? seller.companyName : "None",
      //   };
      // });
      setSaleReports(saleReportsArray);

      setSumAmount(
        saleReportsArray.reduce(
  ...
  return (
    ...
    >
      ...
      >
        ...
        <CardBody pb="15px" justifyContent="center" alignItems="center">
